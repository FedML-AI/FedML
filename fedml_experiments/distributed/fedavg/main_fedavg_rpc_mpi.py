...
from fedml_api.distributed.fedavg.FedAvgAPI import FedML_FedAvg_distributed
...
if __name__ == "__main__":
    ...
    _process_id = _comm.Get_rank()
    args.fl_worker_index = _process_id
    logging.info(args)
    ...
    logging.info(
        "args.gpu_mapping_file = {}, args.gpu_mapping_key = {}".format(args.gpu_mapping_file, args.gpu_mapping_key)
    )
    device = mapping_processes_to_gpu_device_from_yaml_file(
        args.fl_worker_index, num_FL_workers, args.gpu_mapping_file, args.gpu_mapping_key
    )

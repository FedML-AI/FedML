...
from fedml.train.llm.utils import save_config
from transformers import enable_full_determinism, set_seed

from src.utils import parse_hf_args
...
def train() -> None:
    ...
    if not model_args.load_pretrained:
        # if not loading pretrained weights, model initialization need to be fixed
        enable_full_determinism(training_args.seed) if training_args.full_determinism else set_seed(training_args.seed)

...
from src.unitedllm_trainer import UnitedLLMTrainer
from src.utils import log_helper, parse_hf_args
...
class LLMTrainer(ClientTrainer):
    ...
    def set_model_params(self, model_parameters) -> None:
        ...
        self._on_after_set_model_params(model_parameters)

        self.log("finished")

    def _on_after_set_model_params(self, model_parameters) -> None:
        self.log("start")
...
def main(args: Arguments) -> None:
    ...
    training_args, *_ = parse_hf_args(UnitedLLMExperimentArguments, args)

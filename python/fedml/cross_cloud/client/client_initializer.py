...
def init_client(
    ...
    if (
            args.scenario == FEDML_CROSS_CLOUD_SCENARIO_HIERARCHICAL or
            (
                    args.scenario == FEDML_CROSS_CLOUD_SCENARIO_HORIZONTAL and
                    getattr(args, FEDML_CROSS_CLOUD_CUSTOMIZED_HIERARCHICAL_KEY, False)
            )
    ):

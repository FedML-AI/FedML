class MyMessage(object):
    ...
    MSG_TYPE_S2C_SEND_PK_OTHERS_TO_CLIENT = 2
    MSG_TYPE_S2C_SEND_SS_OTHERS_TO_CLIENT = 11
    ...
    # client to server
    MSG_TYPE_C2S_SEND_PK_TO_SERVER = 5
    MSG_TYPE_C2S_SEND_SS_TO_SERVER = 12
    MSG_TYPE_C2S_SEND_MODEL_TO_SERVER = 6
    MSG_TYPE_C2S_SEND_SS_OTHERS_TO_SERVER = 7
    ...
    MSG_ARG_KEY_SK_SS = "sk_ss"
    MSG_ARG_KEY_SK_SS_OTHERS = "sk_ss_list"
    MSG_ARG_KEY_B_SS = "b_ss_list"
    MSG_ARG_KEY_B_SS_OTHERS = "b_ss_list"
    ...
    MSG_ARG_KEY_FINITE_W = "finite_w"
    MSG_ARG_KEY_INFINITE_W = "infinite_w"

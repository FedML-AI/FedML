...
class ClientMasterManager(FedMLCommManager):
    ...
    def __init__(self, args, trainer_dist_adapter, comm=None, rank=0, size=0, backend="MPI"):
        ...
        Args:
            ...
            backend: The communication backend (default is "MPI").
        """
    ...
    def use_customized_hierarchical(self) -> bool:
        """
        Check if customized hierarchical cross-silo is enabled.

        Returns:
            bool: True if customized hierarchical is enabled, False otherwise.
        """
    ...
    def has_customized_sync_process_group(self) -> bool:
        """
        Check if a customized sync process group method is available in the trainer.

        Returns:
            bool: True if a customized sync process group method is available, False otherwise.
        """
    ...
    def handle_message_init(self, msg_params):
        ...
        if self.args.scenario == FEDML_CROSS_SILO_SCENARIO_HIERARCHICAL:
            ...
            self.customized_sync_process_group(
                0, global_model_params, data_silo_index)
    ...
    def handle_message_receive_model_from_server(self, msg_params):
        ...
        if self.args.scenario == FEDML_CROSS_SILO_SCENARIO_HIERARCHICAL:
            ...
            self.customized_sync_process_group(
                self.round_idx, model_params, client_index)
    ...
    def send_model_to_server(self, receive_id, weights, local_sample_num):
        ...
        Args:
            ...
            weights: The model weights to send.
    ...
    def send_client_status(self, receive_id, status=ONLINE_STATUS_FLAG):
        ...
        if self.is_main_process():
            ...
            logging.info("self.client_real_id = {}".format(
                self.client_real_id))
    ...
    def sync_process_group(
        ...
        """
        Synchronize the process group for hierarchical cross-silo scenarios.
    ...
    def customized_sync_process_group(
        ...
        """
        Synchronize the process group using a customized method for hierarchical cross-silo scenarios.

...
class ProcessGroupManager:
    def __init__(self, rank, world_size, master_address, master_port, only_gpu):
        """
        Initialize a process group manager for distributed training.
        ...
        Args:
            ...
            only_gpu (bool): Whether to use NCCL backend for GPU communication.
    ...
    def get_process_group(self):
        ...
        Returns:
            torch.distributed.ProcessGroup: The process group for communication.

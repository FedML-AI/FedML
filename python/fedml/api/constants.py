...
class ApiConstants:
    ...
    LAUNCH_JOB_STATUS_REQUEST_SUCCESS = "LAUNCH_REQUEST_SUCCESS"
    ...
    LAUNCH_JOB_STATUS_BLOCKED = "LAUNCH_JOB_STATUS_BLOCKED"
    ...
    ERROR_CODE = {RESOURCE_MATCHED_STATUS_MATCHED: 1, RESOURCE_MATCHED_STATUS_JOB_URL_ERROR: 2,
                  ...
                  LAUNCH_JOB_STATUS_INVALID: 17, LAUNCH_JOB_STATUS_BLOCKED: 18, APP_UPDATE_FAILED: 19, LAUNCH_JOB_STATUS_REQUEST_SUCCESS: 20}

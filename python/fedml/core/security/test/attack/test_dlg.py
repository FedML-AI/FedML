...
from fedml.core.security.test.utils import create_fake_gradient_Cifar100, create_fake_model_Cifar100
...
def test__attack_dlg():
    ...
    attack = DLGAttack(data_size = [3,32,32], num_class=100, model=LeNet(), criterion=cross_entropy_for_onehot, attack_epoch=100)

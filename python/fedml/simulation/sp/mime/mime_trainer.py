...
from fedml.ml.trainer.mime_trainer import MimeModelTrainer
...
class MimeTrainer(object):
    def __init__(self, dataset, model, device, args):
        ...
        self.model_trainer = MimeModelTrainer(model, args)
    ...
    def train(self):
        ...
        for round_idx in range(self.args.comm_round):
            ...
            for idx, client in enumerate(self.client_list):
                ...
                w, local_grad = client.train(copy.deepcopy(w_global), copy.deepcopy(self.grad_global), copy.deepcopy(self.named_states))
            ...
            w_global, self.grad_global = self._aggregate(w_locals)
    ...
    def _instanciate_opt(self):
        ...
        self.opt_loader = OptimizerLoader(self.model_trainer.model, self.opt)

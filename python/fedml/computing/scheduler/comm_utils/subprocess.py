...
class Popen(object):
    ...
    def communicate(self, input=None, timeout=None, data_arrived_callback=None, error_processor=None):
    ...
    if _mswindows:
        ...
        def _communicate(self, input, endtime, orig_timeout, data_arrived_callback=None, error_processor=None):
                    ...
                    for key, events in ready:
                        if key.fileobj is self.stdin:
                            ...
                            if not data:
                                ...
                                if data_arrived_callback is not None:
                                    data_arrived_callback(
                                        data, is_err=True if key.fileobj == self.stderr else False,

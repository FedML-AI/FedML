...
def get_dataloader_CIFAR10(datadir, train_bs, test_bs, dataidxs=None, n_dist_worker=1):
    ...
    for rank in range(n_dist_worker):
            ...
            train_dl = data.DataLoader(
                dataset=train_ds, batch_size=train_bs, shuffle=(train_sampler is None), drop_last=True,
            ...
            test_dl = data.DataLoader(
                dataset=test_ds,batch_size=test_bs, shuffle=False, drop_last=True, sampler=test_sampler
            )        
            train_data_loaders.append(train_dl)
            test_data_loaders.append(test_dl)

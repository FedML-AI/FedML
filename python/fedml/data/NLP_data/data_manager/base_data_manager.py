...
from fedml.data.NLP_data.data_preprocessing.base.base_data_loader import BaseDataLoader
...
class BaseDataManager(ABC):
    ...
    def load_federated_data(self, test_cut_off=None):
        train_data_num, test_data_num, train_data_global, test_data_global = self._load_federated_data_server(test_cut_off=test_cut_off)
        train_data_local_num_dict, train_data_local_dict, test_data_local_dict, num_clients = self._load_federated_data_local()
        return (train_data_num, test_data_num, train_data_global, test_data_global, train_data_local_num_dict, train_data_local_dict, test_data_local_dict, num_clients)
    ...
    def _load_federated_data_local(self):
        ...
        return (train_data_local_num_dict, train_data_local_dict, test_data_local_dict, self.num_clients)
    ...
    def _load_data_loader_from_cache(self, client_id):
        ...
        cached_features_file = os.path.join(
            model_args.cache_dir, args.model_type + "_" + args.model.split("/")[-1] + "_cached_" + str(args.max_seq_length) + "_" + model_args.model_class + "_"

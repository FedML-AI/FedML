...
import fedml
from fedml.cli.modules import login, logs, launch, diagnosis, logout, build, model, device, cluster, \
    run, train, federate, dataset
...
cli.add_command(dataset.fedml_dataset)

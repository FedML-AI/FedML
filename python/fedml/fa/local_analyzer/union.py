...
class UnionClientAnalyzer(FAClientAnalyzer):
    """
    A client analyzer for finding the union of values in the training data.
    ...
    Methods:
        local_analyze(train_data, args):
            Analyze the training data to find the union of values and set the client submission.

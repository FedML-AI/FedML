...
class AggregationFunction:
    ...
    @staticmethod
    # FedAVG with 2 params; consistent with fedml aggregator; later will remove AggregationFunction.FedAVG
    def FedAVG2(args, raw_grad_list):
        (num0, avg_params) = raw_grad_list[0]
        training_num = get_total_sample_num(raw_grad_list)
        for k in avg_params.keys():

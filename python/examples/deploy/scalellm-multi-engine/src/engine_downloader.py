...
LOCAL_ROOT = os.environ.get("LOCAL_ROOT", "~/.fedml/fedml_scalellm_engine")
ENGINE_DICT = {
    "Llama-2-13b-chat-hf": {
...
if __name__ == "__main__":
    # download_engine("Llama-2-13b-chat-hf", hash_check=False)
    download_engine("MythoMax-L2-13b", hash_check=False)
    # download_engine("Nous-Hermes-13b-bf16", hash_check=False)
    # download_engine("Nous-Hermes-13b-int8-kv", hash_check=False)
...
def download_engine(hash_check:bool = False)-> str:
    s3_address_prefix = "https://fedml-scalellm.s3.us-west-1.amazonaws.com"
    local_dst_refix = "~/fedml_scalellm_engine"
    ...
    if not os.path.exists(engine_dir):
        ...
        for file_name in ["config.json", "llama_float16_tp1_rank0.engine", "model.cache"]:

...
class Txt2ImgXLPipeline(StableDiffusionPipeline):
    ...
    def infer(
        ...
        f"Got prompt length {len(prompt)} and negative prompt length {len(negative_prompt)}" + \
        ...
        with torch.inference_mode():
            ...
            if not warmup:
                ...
                paths = self.save_image(images, 'txt2img-xl', prompt)

        return images, paths, (e2e_toc - e2e_tic)*1000.

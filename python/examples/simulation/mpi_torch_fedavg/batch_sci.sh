...
# --federated_optimizer FedAvg --local_cache False  --learning_rate 0.05 --batch_size 128 \
...
# --worker_num 5 --gpu_util_parse 'localhost:6,0,0,0' \
# --model resnet18_cifar  --group_norm_channels 32 \
# --federated_optimizer FedProx --local_cache False  --learning_rate 0.05 --batch_size 128 \
# --dataset cifar10  --data_cache_dir "/home/comp/20481896/datasets/cifar10" \
# --client_num_in_total 10 --client_num_per_round 5 --comm_round 5 --epochs 1 \
# --frequency_of_the_test 3 \
# --aggregate_seq False --hierarchical_agg False \
...
# --worker_num 9 --gpu_util_parse 'localhost:3,0,0,0' \
# --model resnet18_cifar  --group_norm_channels 32 \
# --federated_optimizer FedOpt --local_cache False  --learning_rate 0.05 --batch_size 128 \
...
# --worker_num 9 --gpu_util_parse 'localhost:3,0,0,0' \
# --model resnet18_cifar  --group_norm_channels 32 \
# --federated_optimizer FedNova --local_cache False  --learning_rate 0.05 --batch_size 128 \
# --dataset cifar10  --data_cache_dir "/home/comp/20481896/datasets/cifar10" \
# --client_num_in_total 10 --client_num_per_round 5 --comm_round 5 --epochs 1 \
# --frequency_of_the_test 3 \
# --aggregate_seq True --hierarchical_agg True \
...
# --worker_num 9 --gpu_util_parse 'localhost:3,0,0,0' \
# --model resnet18_cifar  --group_norm_channels 32 \
# --federated_optimizer SCAFFOLD --local_cache True --learning_rate 0.01 --batch_size 128 \
# --dataset cifar10  --data_cache_dir "/home/comp/20481896/datasets/cifar10" \
# --client_num_in_total 10 --client_num_per_round 5 --comm_round 5 --epochs 1 \
# --frequency_of_the_test 3 \
# --aggregate_seq True --hierarchical_agg True \
...
# --client_optimizer sgd --learning_rate 0.05 --momentum 0.9 --batch_size 128 \
...
--server_optimizer sgd --server_lr 0.1  --server_momentum 0.9 \
--dataset cifar10  --data_cache_dir "/home/comp/20481896/datasets/cifar10" \
--client_num_in_total 10 --client_num_per_round 10 --comm_round 100 --epochs 1 \
...
# --worker_num 9 --gpu_util_parse 'localhost:3,0,2,0' \
# --model resnet18_cifar  --group_norm_channels 32 \
# --federated_optimizer FedOpt --local_cache False  --learning_rate 0.1 --batch_size 128 \
# --server_optimizer sgd --server_lr 0.1  --server_momentum 0.9 \
# --dataset cifar10  --data_cache_dir "/home/comp/20481896/datasets/cifar10" \
# --client_num_in_total 10 --client_num_per_round 10 --comm_round 100 --epochs 1 \
# --frequency_of_the_test 10 \

...
/home/esetstore/.local/openmpi-4.0.1/bin/mpirun -np 17 -host "gpu12:5,gpu13:4,gpu14:4,gpu15:4" \
...
--worker_num 17 --gpu_util_parse 'gpu12:2,1,1,1;gpu13:1,1,1,1;gpu14:1,1,1,1;gpu15:1,1,1,1' \
...
--device_tag eset --tag ready --exp_name e_img_c100_k16_hier_sche --wandb_id e_img_c100_k16_hier_sche
...
--tracking_runtime True \
--device_tag eset --tag Ready --exp_name e_img_c100_k16_hier --wandb_id e_img_c100_k16_hier
...
--simulation_schedule "LinearFit-DP" --runtime_est_mode history \
--tracking_runtime True \
--device_tag eset --tag ready --exp_name e_fem_c100_k16_hier_sche --wandb_id e_fem_c100_k16_hier_sche
...
--runtime_est_mode history \
--tracking_runtime True \
--device_tag eset --tag Ready --exp_name e_fem_c100_k16_hier --wandb_id e_fem_c100_k16_hier

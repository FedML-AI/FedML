...
--device_tag eset --tag debug --exp_name e_fem_c1000_k4_hier_sche --wandb_id e_fem_c1000_k4_hier_sche
...
--tracking_runtime True \
--device_tag eset --tag Ready --exp_name e_fem_c1000_k4_hier --wandb_id e_fem_c1000_k4_hier

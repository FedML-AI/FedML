...
/home/esetstore/.local/openmpi-4.0.1/bin/mpirun -np 9 -host "gpu15:5,gpu14:4" \
...
--worker_num 9 --gpu_util_parse 'gpu15:2,1,1,1;gpu14:1,1,1,1' \
...
--device_tag eset --tag debug --exp_name e_img_c1000_k8_hier_sche --wandb_id e_img_c1000_k8_hier_sche
...
--tracking_runtime True \
--device_tag eset --tag Ready --exp_name e_img_c1000_k8_hier --wandb_id e_img_c1000_k8_hier

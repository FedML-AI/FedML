...
export class FedMLCommManager {
  ...
  register_comm_manager(comm_manager) {
  ...
  async init_manager() {
    ...
    this.com_manager = new MqttS3MultiClientsCommManager(mqtt_config, s3_config, this.args.run_id, this.rank, this.size, this.args)

...
export class TrainerDistAdapter {
  constructor(args, device, client_rank, model, trainData, trainDataLabel, testData, testDataLabel, model_trainer = null) {
    if (model_trainer == null)
      this.model_trainer = this.create_model_trainer(model, trainData, trainDataLabel, testData, testDataLabel, args)
    ...
    const trainer = this.get_trainer(client_index, trainData, trainDataLabel, testData, testDataLabel, device, args, this.model_trainer)
  ...
  /**
     ...
     */
  get_trainer(client_index, trainData, trainDataLabel, testData, testDataLabel, device, args, model_trainer) {
    return new FedMLTrainer(client_index, trainData, trainDataLabel, testData, testDataLabel, device, args, model_trainer)
  }
  ...
  create_model_trainer(model, trainData, trainDataLabel, testData, testDataLabel, args) {
    const model_trainer = new ModelTrainerCLS(model, trainData, trainDataLabel, testData, testDataLabel, args)

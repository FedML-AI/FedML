...
export class Cifar10 extends DataSet {
  constructor() {
    super(...arguments)
    this.TRAIN_IMAGES = [data_batch_1, data_batch_2, data_batch_3, data_batch_4, data_batch_5]
    this.TRAIN_LABLES = train_lables
    this.TEST_IMAGES = [test_batch]
    this.TEST_LABLES = test_lables
  }

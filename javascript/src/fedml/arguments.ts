...
const runArgsJSON = {
  ...
  packages_config: {
    ...
    androidClientUrl: '',
    serverUrl:
      'https://fedml.s3.us-west-1.amazonaws.com/1658063399409server-package.zip',
    androidClient: '',
    linuxClientUrl:
      'https://fedml.s3.us-west-1.amazonaws.com/1658063403141client-package.zip',
  },
  data_config: {
    privateLocalData: '',
    syntheticDataUrl: '',
...
export class Arguments<T extends RunArgsJSON> {
  ...
  constructor(
    ...
    if (!override_cmd_args)
      for (const j in cmd_args) this[j] = cmd_args[j]
  }

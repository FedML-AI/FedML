...
export async function fedml_train(run_args: any, client_id: string | number, options?: Options) {
  ...
  if (options && options?.customDataLoader) _dataLoader = options.customDataLoader;

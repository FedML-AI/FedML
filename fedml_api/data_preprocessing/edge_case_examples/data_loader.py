    ...
    if args.dataset in ("mnist", "emnist"):
        ...
        if args.poison_type == "southwest":
            ...
            if args.attack_case == "edge-case":
                with open('./../../../data/edge_case_examples/southwest_cifar10/southwest_images_new_train.pkl', 'rb') as train_f:
                    saved_southwest_dataset_train = pickle.load(train_f)

                with open('./../../../data/edge_case_examples/southwest_cifar10/southwest_images_new_test.pkl', 'rb') as test_f:
                    saved_southwest_dataset_test = pickle.load(test_f)
            elif args.attack_case == "normal-case" or args.attack_case == "almost-edge-case":
                with open('./../../../data/edge_case_examples/southwest_cifar10/southwest_images_adv_p_percent_edge_case.pkl', 'rb') as train_f:
                    saved_southwest_dataset_train = pickle.load(train_f)

                with open('./../../../data/edge_case_examples/southwest_cifar10/southwest_images_p_percent_edge_case_test.pkl', 'rb') as test_f:
                    saved_southwest_dataset_test = pickle.load(test_f)
            else:
            ...
            with open('./../../../data/edge_case_examples/greencar_cifar10/green_car_transformed_test.pkl', 'rb') as test_f:

...
from datasets import MNIST_truncated, CIFAR10_truncated, ImageFolderTruncated
...
def partition_data(dataset, datadir, logdir, partition, n_nets, alpha, args):
    ...
    if partition == "homo":
        ...
        net_dataidx_map = read_net_dataidx_map()
    ...
    if partition == "hetero-fix":
        traindata_cls_counts = read_data_distribution()
    else:
        traindata_cls_counts = record_net_data_stats(y_train, net_dataidx_map, logdir)

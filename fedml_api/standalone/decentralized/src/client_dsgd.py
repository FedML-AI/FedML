...
class ClientDSGD(object):
    def __init__(self, client_id, streaming_data, topology_manager,
                 input_dim, output_dim, iteration_number,
        ...
        self.model = ClientModel(input_dim, output_dim)
        ...
        self.model_x = ClientModel(input_dim, output_dim)
